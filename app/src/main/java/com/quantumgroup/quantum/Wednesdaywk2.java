...
public class Wednesdaywk2  extends Fragment  {
    ...
    private AdapterWednesday mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,  Bundle savedInstanceState) {
        ...
        String mydate = settings.getString("date1", null);
        return rootView;
    }
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                url = new URL("http://192.168.43.68:5000/manager/foods?date=2016-08-3");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                mAdapter = new AdapterWednesday(getActivity(), data);
