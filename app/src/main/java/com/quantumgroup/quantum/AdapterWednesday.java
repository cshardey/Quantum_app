 ...
 */
public class AdapterWednesday extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterWednesday(Context context, List<DataLunch> data) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        String food_date = date.getString("date3", null);
    ...
    public class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            final String food_date = date.getString("date3", null);

            SharedPreferences settings = context.getSharedPreferences(Wednesday.PREFS_NAME, 0); // 0 - for private mode
