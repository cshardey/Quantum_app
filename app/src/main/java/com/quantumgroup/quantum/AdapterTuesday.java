 ...
 */
public class AdapterTuesday extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterTuesday(Context context, List<DataLunch> data) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        String food_date = date.getString("date2", null);
    ...
    public class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            final String food_date = date.getString("date2", null);

            SharedPreferences settings = context.getSharedPreferences(Tuesday.TUESDAY_MEAL, 0); // 0 - for private mode
