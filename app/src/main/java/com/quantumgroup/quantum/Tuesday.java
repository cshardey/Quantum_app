...
public class Tuesday  extends Fragment  {
    ...
    public static final String TUESDAY_MEAL = "Tuesday";
...
//        mydate=getArguments().getString("week","");
        ...
        mydate = settings.getString("date2", null);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences settings = getContext().getSharedPreferences(Tuesday.TUESDAY_MEAL, 0);
