...
public class Thursday  extends Fragment  {
    ...
    private AdapterThursday mAdapter;
    public static final String PREFS_NAME = "Thursday";
    TextView error;
    String access_token;
    String responseJson;
    Integer status;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,  Bundle savedInstanceState) {
        ...
        mydate = settings.getString("date4", null);
            ...
            try {
                ...
                if (result_payload.has("status")){
                    ...
                    if (status == 200){
                        ...
                        mAdapter = new AdapterThursday(getActivity(), data);
