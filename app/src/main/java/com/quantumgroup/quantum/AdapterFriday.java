 ...
 */
public class AdapterFriday extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterFriday(Context context, List<DataLunch> data) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        String food_date = date.getString("date5", null);
        ...
        //Log.i("MyArray",cr_date.toString());
    ...
    public class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            final String food_date = date.getString("date5", null);

            SharedPreferences settings = context.getSharedPreferences(Friday.PREFS_NAME, 0); // 0 - for private mode
