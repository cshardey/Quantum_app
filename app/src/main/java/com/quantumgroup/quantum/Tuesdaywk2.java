...
public class Tuesdaywk2  extends Fragment  {
    String food_date;
    public static final int CONNECTION_TIMEOUT = 10000;
    public static final int READ_TIMEOUT = 15000;
    private RecyclerView lunch;
    private AdapterTuesday mAdapter;
    public static final String TUESDAY_MEAL = "TuesdayPref";
    View rootView;

    public View onCreateView(LayoutInflater inflater, ViewGroup container,  Bundle savedInstanceState) {
         rootView = inflater.inflate(R.layout.activity_tuesdaywk2, container, false);
        SharedPreferences settings = this.getActivity().getSharedPreferences(Week2.PREFS_NAME, 0);
         food_date= settings.getString("date2", null);
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                mAdapter = new AdapterTuesday(getActivity(), data);
